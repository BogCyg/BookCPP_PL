...
namespace CppBook
{
	...
	class TStackFor< std::unique_ptr< T >, MaxElems >
	{
		...
		public:
			...
			///////////////////////////////////////////////////////////
			//		
			// INPUT:	new_elem - a smart pointer to the object to
			//				be moved onto the stack.
			//		
			...
			///////////////////////////////////////////////////////////
			//		
			// INPUT:	new_elem - a reference to the smart pointer to 
			//				the object, which the topmost element from
			//				the stack will be moved to. Then the topmost 
